...
reg('enchant_top', p => { p.noise([40, 34, 48], 0.15); p.rect(3, 3, 10, 10, [180, 60, 70]); p.rect(5, 5, 6, 6, [220, 210, 230]); p.rect(7, 5, 1, 6, [120, 60, 70]); });
reg('enchant_side', p => { p.noise(C.obsidian, 0.2); p.rect(0, 0, 16, 3, [200, 180, 220]); p.speck([90, 60, 130], 10); p.blob(8, 9, 2, [70, 220, 220]); });
...
const ITEM_ART = {
  ...
  golden_apple: () => art(['.......H........', '......H.........', '....GGGGG.......', '...GGgGGGG......', '...GGgGGGG......', '...GGGGGGG......', '....GGGGG.......'], { G: [245, 211, 74], g: [255, 240, 160], H: [90, 60, 30] }),
